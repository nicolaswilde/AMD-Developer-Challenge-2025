...
CPP_WRAPPER = """
void mm32x32(torch::Tensor a, torch::Tensor b, torch::Tensor as, torch::Tensor bs, torch::Tensor c, int m, int n, int k);
void mm64x64(torch::Tensor a, torch::Tensor b, torch::Tensor as, torch::Tensor bs, torch::Tensor c, int m, int n, int k);
void mm128x128ft(torch::Tensor a, torch::Tensor b, torch::Tensor as, torch::Tensor bs, torch::Tensor c, int m, int n, int k);
void mm128x128pt(torch::Tensor a, torch::Tensor b, torch::Tensor as, torch::Tensor bs, torch::Tensor c, int m, int n, int k);
"""
...
module = load_inline(
    ...
    functions=['mm32x32', 'mm64x64', 'mm128x128ft', 'mm128x128pt'],
    verbose=True,
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if (m == 1024 and n == 1536 and k == 7168):
        module.mm64x64(a, b, a_scale, b_scale, c, m, n, k)
    # 1. m: 1024; n: 3072; k: 1536
    elif (m == 1024 and n == 3072 and k == 1536):
        module.mm128x128ft(a, b, a_scale, b_scale, c, m, n, k)
    # 2. m: 1024; n: 576 ; k: 7168
    elif (m == 1024 and n == 576 and k == 7168):
        module.mm32x32(a, b, a_scale, b_scale, c, m, n, k)
    # 3. m: 1024; n: 7168; k: 256
    elif (m == 1024 and n == 7168 and k == 256):
        module.mm128x128ft(a, b, a_scale, b_scale, c, m, n, k)
    # 4. m: 1024; n: 7168; k: 2048
    elif (m == 1024 and n == 7168 and k == 2048):
        module.mm128x128ft(a, b, a_scale, b_scale, c, m, n, k)
    # 5. m: 1024; n: 4608; k: 7168
    elif (m == 1024 and n == 4608 and k == 7168):
        module.mm128x128ft(a, b, a_scale, b_scale, c, m, n, k)
    # 6. m: 1024; n: 7168; k: 2304
    elif (m == 1024 and n == 7168 and k == 2304):
        module.mm128x128pt(a, b, a_scale, b_scale, c, m, n, k)
    # 7. m: 1024; n: 512 ; k: 7168
    elif (m == 1024 and n == 512 and k == 7168):
        module.mm32x32(a, b, a_scale, b_scale, c, m, n, k)
    # 8. m: 1024; n: 4096; k: 512
    elif (m == 1024 and n == 4096 and k == 512):
        module.mm128x128ft(a, b, a_scale, b_scale, c, m, n, k)
    # 9. m: 6144; n: 1536; k: 7168
    elif (m == 6144 and n == 1536 and k == 7168):
        module.mm128x128pt(a, b, a_scale, b_scale, c, m, n, k)
    # 10. m: 6144; n: 3072; k: 1536
    elif (m == 6144 and n == 3072 and k == 1536):
        module.mm128x128pt(a, b, a_scale, b_scale, c, m, n, k)
    # 11. m: 6144; n: 576 ; k: 7168; 12096
    elif (m == 6144 and n == 576 and k == 7168):
        module.mm128x128ft(a, b, a_scale, b_scale, c, m, n, k)
    # 12. m: 6144; n: 7168; k: 256 ; 5376
    elif (m == 6144 and n == 7168 and k == 256):
        module.mm128x128pt(a, b, a_scale, b_scale, c, m, n, k)
    # 13. m: 6144; n: 7168; k: 2048
    elif (m == 6144 and n == 7168 and k == 2048):
        module.mm128x128pt(a, b, a_scale, b_scale, c, m, n, k)
    # 14. m: 6144; n: 4608; k: 7168
    elif (m == 6144 and n == 4608 and k == 7168):
        module.mm128x128pt(a, b, a_scale, b_scale, c, m, n, k)
    # 15. m: 6144; n: 7168; k: 2304
    elif (m == 6144 and n == 7168 and k == 2304):
        module.mm128x128pt(a, b, a_scale, b_scale, c, m, n, k)
    # 16. m: 6144; n: 512 ; k: 7168
    elif (m == 6144 and n == 512 and k == 7168):
        module.mm128x128ft(a, b, a_scale, b_scale, c, m, n, k)
    # 17. m: 6144; n: 4096; k: 512
    elif (m == 6144 and n == 4096 and k == 512):
        module.mm128x128pt(a, b, a_scale, b_scale, c, m, n, k)
    else:
        module.mm32x32(a, b, a_scale, b_scale, c, m, n, k)
